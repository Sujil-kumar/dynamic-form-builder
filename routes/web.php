...
Route::get('/admin/editForm/{id}',[AdminController::class,'editForm'])->name('admin.editForm');
Route::post('/admin/formSave',[AdminController::class,'formSave'])->name('admin.formSave');
Route::post('/admin/editSave',[AdminController::class,'editSave'])->name('admin.editSave');
